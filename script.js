...
//List of flowers in Unocode
const flowerList = ["🌹", "💮", "🌷", "🌺", "🏵", "🌼", "🌻", "💐", "🌸"];
//List of cards
const cardList = ['0 - The Fool',
                'I - The Magician',
...
function composerMessage() {
    ...
    let cookieMessage = predList[getRandNum(predList)];
    let flowerOfDay = flowerList[getRandNum(flowerList)];
    let cardOfDay = cardList[getRandNum(cardList)];


    //putting it all together!
    console.log(`You cracked the cookie and you see:\n${cookieMessage}\n\nThe flower of the day:\n${flowerOfDay}\n\nThe tarot card of the day:\n${cardOfDay}`);
};
